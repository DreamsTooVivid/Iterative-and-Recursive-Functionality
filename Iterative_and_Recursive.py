...
def main():
    ...
    print("0! =", factorial_recursive(5))
    print("0! =", factorial_recursive(10))
    print("0! =", factorial_recursive(25))
    print("0! =", factorial_recursive(50))
    print("0! =", factorial_recursive(100))
